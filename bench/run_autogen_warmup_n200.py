"""autogen_bridge at n=200 under warmup-corrected harness.
...
Requires bench/fixtures/long_context_qa_n300.json (built by
run_lcqa_warmup_n300.py, or run --build-fixture to build it here).
BENCH_FIXTURE_OVERRIDE is set automatically to that path.

Cost estimate: ~$3-6. Ceiling: $20 hard stop ($30 surface-and-abort).

Outputs:
  bench/paper_results/autogen_bridge_warmup_n200.csv
  bench/paper_results/autogen_bridge_warmup_n200_warmup_stats.csv
"""
...
ABORT_CEILING_USD = 30.0
PAPER_RESULTS = _REPO / "bench" / "paper_results"
STORAGE_ROOT = Path("/tmp/agentc-autogen-warmup-n200")
FIXTURE_N300 = _REPO / "bench" / "fixtures" / "long_context_qa_n300.json"
FIXTURE_SRC = _REPO / "bench" / "fixtures" / "hotpot_distractor.json"
OUT_PATH = PAPER_RESULTS / "autogen_bridge_warmup_n200.csv"
WARMUP_STATS_PATH = PAPER_RESULTS / "autogen_bridge_warmup_n200_warmup_stats.csv"
