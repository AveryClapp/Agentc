...
\midrule
%% DROPIN [3b]: update Acc $\Delta$ + McNemar p to the n=300 all-on result (cost stays --- ; Together unpriced).
%%   src: python -m bench.paired_analysis bench/paper_results/autogen_bridge-n300-warmup.per_task.csv
%%   currently n=200: -3.0pp, p=0.07. Add bootstrap CI from that tool's output.
