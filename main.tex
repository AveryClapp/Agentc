...
%%  [3a] research_planner accuracy  -> tab:summary row + Limitations sentence
%%       src: bench/paper_results/research_planner-n150-warmup.csv  (+ .per_task.csv for McNemar/CI)
...
%% DROPIN [3a]: replace the whole research_planner row (Cost/Tok/Acc $\Delta$/McNemar) with the all-on
%%   row from bench/paper_results/research_planner_warmup_n150.csv (acc_delta_pp, mcnemar_p columns);
%%   bootstrap CI via paired_analysis on research_planner-n150-warmup.per_task.csv.
...
%% DROPIN [3a]: research_planner NOW has accuracy (n=150 warmup ablation). Revise this sentence:
%%   move research_planner out of the 'no accuracy tracking' set, report its Acc delta + McNemar p,
%%   and leave only debug_agent as cost/token-only.
