...
replications per path, full-call p50/p99 was 0.104/0.351\,ms for guarded reference
selection, 0.118/0.385\,ms for an admitted joint rewrite, and 0.076/0.287\,ms for
the legacy greedy rewrite. The paired internal medians were 0.065, 0.073, and
0.044\,ms, respectively. Their difference combines the FFI boundary, native-state
