...
%%  [3b] autogen_bridge n=300 acc+CI -> tab:summary row + Sec eval-realagent text
%%       src: bench/paper_results/autogen_bridge-n300-warmup.per_task.csv
...
\midrule
%% DROPIN [3b] RESULT (n=300, FAVORABLE): Acc $\Delta$ = $-$0.7\,pp, McNemar p=0.77,
%%   95\% bootstrap CI [$-$3.0, $+$1.7]\,pp (baseline 229/300, opt 227/300). Supersedes n=200
%%   ($-$3.0pp, p=0.07). -> set Acc $\Delta$ to "$-$0.7\,pp (ns, $p$=0.77)" and McNemar col to 0.77.
%% WARNING (Tok column): 38.5\% did NOT reproduce on current code. This n=300 run gives 13.05\%
%%   (CC fired 172x + StateDrop 231x, both COMPOSED); the stored n=200 got 38.5\% (CC 396x SOLO, SD 0).
%%   StateDrop now fires on autogen and composes with CC, lowering aggregate CC savings.
%%   DECISION NEEDED before submission: re-verify 38.5\% or report the reproducible 13.05\% at n=300.
