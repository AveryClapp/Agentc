...
label-free accuracy guard catches the rare rule that misfires, converting a $-$42.7\,pp
StateDrop catastrophe into a non-significant delta while keeping beneficial compression
enabled. On
...
stays enabled at 37.5--37.6\% savings on two agents under the guard). With a
...
The mechanism is rule-agnostic and requires no ground-truth labels.
