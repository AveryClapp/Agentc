---
title: Literature Verified Blurbs
status: active
last-updated: 2026-05-09
owner: paper-intelligence
---

# Literature Verified Blurbs

This is the primary-source verification pass for `LIT-002` through `LIT-070`.
It supersedes the candidate-only blurbs in `literature-blurb-todo.md`.

Each entry has a citation-use blurb, a differentiation note, and an action decision. These are still not final manuscript prose; they are the checked building blocks for the human-written literature review.
