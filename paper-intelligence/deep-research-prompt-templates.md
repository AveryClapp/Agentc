---
title: Deep Research Prompt Templates
status: draft
...
**Purpose:** reusable prompts for collecting literature, positioning, venue fit, and reviewer-risk evidence for the Agentc paper intelligence workspace.
...
[PASTE CLAIMS FROM paper-intelligence/claim-bank.md OR citation-gap-list.md]
...
7. Updates to add to:
   ...
   - paper-intelligence/paper-gap-register.md
   - paper-intelligence/question-backlog.md
```
...
6. Updates to add to:
   - paper-intelligence/venue-positioning-matrix.md
   - paper-intelligence/paper-gap-register.md
   - paper-intelligence/question-backlog.md
```
...
9. Updates to add to:
   - paper-intelligence/literature-ledger.md
   - paper-intelligence/literature-review-section-plan.md
   - paper-intelligence/related-work-map.md
...
7. Updates to add to:
   - paper-intelligence/literature-ledger.md
   - paper-intelligence/style-guide.md
   - paper-intelligence/nearest-neighbor-comparison.md
   - paper-intelligence/citation-gap-list.md
```
